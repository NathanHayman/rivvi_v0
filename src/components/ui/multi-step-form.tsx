  ...
  (
    ...
    return (
      <Card
        ref={ref}
        className={cn(
          "relative overflow-hidden cursor-pointer transition-all hover:ring-2 hover:ring-primary h-full w-full",
          ...
          <>
            {image ? (
              ...
              Icon && (
                <div
                  className={cn(
                    "flex items-center justify-center h-32 md:h-44 bg-muted w-full",
                    imageClassName
                  )}
                >
                  <Icon
          ...
          <>
            ...
            {image ? (
              ...
              Icon && (
                <div
                  className={cn(
                    "flex items-center justify-center h-48 bg-muted w-full",
                    imageClassName
                  )}
                >
                  <Icon
...
const MultiStepForm = React.forwardRef<HTMLDivElement, MultiStepFormProps>(
  (
    ...
    return (
      <div ref={ref} className={cn("w-full h-[500px]", className)} {...props}>
        <div className="mb-8 p-4 md:p-0 w-full">
          ...
          <Progress
            value={
              isSuccessStep ? 100 : ((currentStep + 1) / formSteps.length) * 100
            }
            className="h-2"
          />
          <div className="mt-4">
